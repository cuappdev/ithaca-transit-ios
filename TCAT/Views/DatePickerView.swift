...
class DatePickerView: UIView {
    ...
    private func styleCancelButton() {
        ...
        cancelButton.titleLabel?.font = UIFont.style(Fonts.SanFrancisco.regular, size: 17.0)
    ...
    private func styleDoneButton() {
        ...
        doneButton.titleLabel?.font = UIFont.style(Fonts.SanFrancisco.regular, size: 17.0)

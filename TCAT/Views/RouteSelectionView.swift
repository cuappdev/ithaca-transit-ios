...
class RouteSelectionView: UIView {
    ...
    private func styleLabel(_ label: UILabel) {
        ...
        label.font = UIFont.style(Fonts.SanFrancisco.regular, size: 14.0)
    ...
    private func styleSearchbar(_ searchbar: UIButton) {
        ...
        searchbar.titleLabel?.font = UIFont.style(Fonts.SanFrancisco.regular, size: 14.0)
    ...
    private func styleDatepickerButton() {
        ...
        datepickerButton.titleLabel?.font = UIFont.style(Fonts.SanFrancisco.regular, size: 14.0)
